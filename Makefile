...
sample.out:	main.o init.o update.o parameter.o memory.o
		nvcc -rdc=true -o sample.out ./object/main.o ./object/init.o ./object/update.o ./object/memory.o ./object/parameter.o -Xcompiler -fopenmp -O3
main.o:	./main.cu
